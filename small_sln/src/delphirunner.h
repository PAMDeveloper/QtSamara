...
void run_samara_21(const samara::ModelParameters& parameters, int log_every) {
    ...
    //Model Parameters
    double Altitude = parameters.getDouble("altitude");
    double ASScstr = parameters.getDouble("asscstr");
    double AttenMitch = parameters.getDouble("attenmitch");
    double BundHeight = parameters.getDouble("bundheight");
    double Ca = parameters.getDouble("ca");
    double CO2Cp = parameters.getDouble("co2cp");
    double CO2Exp = parameters.getDouble("co2exp");
    double CO2Slopetr = parameters.getDouble("co2slopetr");
    double CoeffAssimSla = parameters.getDouble("coeffassimsla");
    double CoefficientQ10 = parameters.getDouble("coefficientq10");
    double CoeffInternodeMass = parameters.getDouble("coeffinternodemass");
    double CoeffInternodeNum = parameters.getDouble("coeffinternodenum");
    double CoeffLeafDeath = parameters.getDouble("coeffleafdeath");
    double CoeffLeafWLRatio = parameters.getDouble("coeffleafwlratio");
    double CoeffPanicleMass = parameters.getDouble("coeffpaniclemass");
    double CoeffPanSinkPop = parameters.getDouble("coeffpansinkpop");
    double CoeffResCapacityInternode = parameters.getDouble("coeffrescapacityinternode");
    double CoeffReserveSink = parameters.getDouble("coeffreservesink");
    double CoeffRootMassPerVolMax = parameters.getDouble("coeffrootmasspervolmax");
    double CoeffTillerDeath = parameters.getDouble("coefftillerdeath");
    double CoeffTransplantingShock = parameters.getDouble("coefftransplantingshock");
    double DensityField = parameters.getDouble("densityfield");
    double DensityNursery = parameters.getDouble("densitynursery");
    double DEVcstr = parameters.getDouble("devcstr");
    double DurationNursery = parameters.getDouble("durationnursery");
    double EpaisseurProf = parameters.getDouble("epaisseurprof");
    double EpaisseurSurf = parameters.getDouble("epaisseursurf");
    double ExcessAssimToRoot = parameters.getDouble("excessassimtoroot");
    double FTSWIrrig = parameters.getDouble("ftswirrig");
    double HaunCritTillering = parameters.getDouble("hauncrittillering");
    double HumFC = parameters.getDouble("humfc");
    double HumPF = parameters.getDouble("humpf");
    double HumSat = parameters.getDouble("humsat");
    double IcTillering = parameters.getDouble("ictillering");
    double InternodeLengthMax = parameters.getDouble("internodelengthmax");
    double IrrigAuto = parameters.getInt("irrigauto");
    double IrrigAutoResume = parameters.getDouble("irrigautoresume");
    double IrrigAutoStop = parameters.getDouble("irrigautostop");
    double IrrigAutoTarget = parameters.getDouble("irrigautotarget");
    double KcMax = parameters.getDouble("kcmax");
    double KCritSterCold1 = parameters.getDouble("kcritstercold1");
    double KCritSterCold2 = parameters.getDouble("kcritstercold2");
    double KCritSterFtsw1 = parameters.getDouble("kcritsterftsw1");
    double KCritSterFtsw2 = parameters.getDouble("kcritsterftsw2");
    double KCritSterHeat1 = parameters.getDouble("kcritsterheat1");
    double KCritSterHeat2 = parameters.getDouble("kcritsterheat2");
    double KCritStressCold1 = parameters.getDouble("kcritstresscold1");
    double KCritStressCold2 = parameters.getDouble("kcritstresscold2");
    double Kdf = parameters.getDouble("kdf");
    double KPar = parameters.getDouble ("kpar");
    double KRespInternode = parameters.getDouble("krespinternode");
    double KRespMaintLeaf = parameters.getDouble("krespmaintleaf");
    double KRespMaintRoot = parameters.getDouble("krespmaintroot");
    double KRespMaintSheath = parameters.getDouble("krespmaintsheath");
    double KRespPanicle = parameters.getDouble("kresppanicle");
    double KTempMaint = parameters.getDouble("ktempmaint");
    double Latitude = parameters.getDouble("latitude");
    double LeafLengthMax = parameters.getDouble("leaflengthmax");
    double LifeSavingDrainage = parameters.getDouble("lifesavingdrainage");
    double Mulch = parameters.getDouble("mulch");
    double PanStructMassMax = parameters.getDouble("panstructmassmax");
    double PercolationMax = parameters.getDouble("percolationmax");
    double PEvap = parameters.getDouble("pevap");
    double PFactor = parameters.getDouble("pfactor");
    double Phyllo = parameters.getDouble("phyllo");
    double PlantsPerHill = parameters.getDouble("plantsperhill");
    double PlotDrainageDAF = parameters.getDouble("plotdrainagedaf");
    double PoidsSecGrain = parameters.getDouble("poidssecgrain");
    double PourcRuiss = parameters.getDouble("pourcruiss");
    double PPCrit = parameters.getDouble("ppcrit");
    double PPExp = parameters.getDouble("ppexp");
    double PPSens = parameters.getDouble("ppsens");
    double PriorityPan = parameters.getDouble("prioritypan");
    double ProfRacIni = parameters.getDouble("profracini");
    double RankLongestLeaf = parameters.getDouble("ranklongestleaf");
    double RelMobiliInternodeMax = parameters.getDouble("relmobiliinternodemax");
    double RelPhylloPhaseStemElong = parameters.getDouble("relphyllophasestemelong");
    double RollingBase = parameters.getDouble("rollingbase");
    double RollingSens = parameters.getDouble("rollingsens");
    double RootCstr = parameters.getDouble("rootcstr");
    double RootFrontMax = parameters.getDouble("rootfrontmax");
    double RootPartitMax = parameters.getDouble("rootpartitmax");
    double SDJBVP = parameters.getDouble("sdjbvp");
    double SDJLevee = parameters.getDouble("sdjlevee");
    double SDJMatu1 = parameters.getDouble("sdjmatu1");
    double SDJMatu2 = parameters.getDouble("sdjmatu2");
    double SDJRPR = parameters.getDouble("sdjrpr");
    double SeuilPP = parameters.getDouble("seuilpp");
    double SeuilRuiss = parameters.getDouble("seuilruiss");
    double SlaMax = parameters.getDouble("slamax");
    double SlaMin = parameters.getDouble("slamin");
    double StockIniProf = parameters.getDouble("stockiniprof");
    double StockIniSurf = parameters.getDouble("stockinisurf");
    double TBase = parameters.getDouble("tbase");
    double TempSLA = parameters.getDouble("tempsla");
    double TilAbility = parameters.getDouble("tilability");
    double TLim = parameters.getDouble("tlim");
    double TOpt1 = parameters.getDouble("topt1");
    double TOpt2 = parameters.getDouble("topt2");
    double Transplanting = parameters.getDouble("transplanting");
    double TransplantingDepth = parameters.getDouble("transplantingdepth");
    double TxAssimBVP = parameters.getDouble("txassimbvp");
    double TxAssimMatu1 = parameters.getDouble("txassimmatu1");
    double TxAssimMatu2 = parameters.getDouble("txassimmatu2");
    double TxConversion = parameters.getDouble("txconversion");
    double TxResGrain = parameters.getDouble("txresgrain");
    double TxRuSurfGermi = parameters.getDouble("txrusurfgermi");
    double VRacBVP = parameters.getDouble("vracbvp");
    double VRacLevee = parameters.getDouble("vraclevee");
    double VRacMatu1 = parameters.getDouble("vracmatu1");
    double VRacMatu2 = parameters.getDouble("vracmatu2");
    double VRacPSP = parameters.getDouble("vracpsp");
    double VRacRPR = parameters.getDouble("vracrpr");
    double WaterLoggingSens = parameters.getDouble("waterloggingsens");
    double WtRatioLeafSheath = parameters.getDouble("wtratioleafsheath");
