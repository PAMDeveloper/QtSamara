...
void run_samara_21(double start, double end, const samara::ModelParameters& parameters) {
    ...
    // TrEffInst<>TrEff
//    ConversionEff<>WueTot  PAS NORMAL
//    CumWReceived<>CumWUse  égalité requise mais pas même calcul-- Stress Hydrique
    //- CumDr<>CumLr PAS NORMAL -- Stress Hydrique (Lr ruissellement, Dr drainage)
    //CumWUse<>CumTr -
    //ParIntercepte<>RUE - Mon RUE parait bon
    //WueEt<>TrEff - PAS BON DANS DELPHI
