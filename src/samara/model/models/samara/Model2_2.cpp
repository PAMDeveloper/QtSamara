...
double SamaraModel2_2::NullValue = -999;

void SamaraModel2_2::compute(double t, bool /* update */)
{
...
void SamaraModel2_2::init(double t, const model::models::ModelParameters& parameters)
{
