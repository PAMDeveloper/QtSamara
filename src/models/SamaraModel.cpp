...
void SamaraModel::writeResultInDB(const std::string idsimu,double jour)
{
    ...
    occurrenceResult["jour"] = artis::utils::DateTime::toJulianDay(jour);
                 ...
                 const samara::ModelParameters& parameters)
{
    ...
    DateSemis = artis::utils::DateTime::toJulianDayNumber(parameters.get<std::string>("datesemis"));
