...
#ifndef MODEL_OBSERVER_CULMSPERHILLVIEW_HPP
#define MODEL_OBSERVER_CULMSPERHILLVIEW_HPP
...
class CULMSPERHILLView : public View
{
public:
    CULMSPERHILLView()
    { }

    virtual ~CULMSPERHILLView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->culmsperhill();
    }
};
