...
#ifndef MODEL_OBSERVER_SUPPLYTOTVIEW_HPP
#define MODEL_OBSERVER_SUPPLYTOTVIEW_HPP
...
class SUPPLYTOTView : public View
{
public:
    SUPPLYTOTView()
    { }

    virtual ~SUPPLYTOTView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->supplytot();
    }
};
