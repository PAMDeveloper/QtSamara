...
#ifndef MODEL_OBSERVER_STERILITYTOTVIEW_HPP
#define MODEL_OBSERVER_STERILITYTOTVIEW_HPP
...
class STERILITYTOTView : public View
{
public:
    STERILITYTOTView()
    { }

    virtual ~STERILITYTOTView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->sterilitytot();
    }
};
