...
#ifndef MODEL_OBSERVER_STOCKTOTALVIEW_HPP
#define MODEL_OBSERVER_STOCKTOTALVIEW_HPP
...
class STOCKTOTALView : public View
{
public:
    STOCKTOTALView()
    { }

    virtual ~STOCKTOTALView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->stocktotal();
    }
};
