...
#ifndef MODEL_OBSERVER_IRRIGTOTDAYVIEW_HPP
#define MODEL_OBSERVER_IRRIGTOTDAYVIEW_HPP
...
class IRRIGTOTDAYView : public View
{
public:
    IRRIGTOTDAYView()
    { }

    virtual ~IRRIGTOTDAYView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->irrigtotday();
    }
};
