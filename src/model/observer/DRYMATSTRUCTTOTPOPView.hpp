...
#ifndef MODEL_OBSERVER_DRYMATSTRUCTTOTPOPVIEW_HPP
#define MODEL_OBSERVER_DRYMATSTRUCTTOTPOPVIEW_HPP
...
class DRYMATSTRUCTTOTPOPView : public View
{
public:
    DRYMATSTRUCTTOTPOPView()
    { }

    virtual ~DRYMATSTRUCTTOTPOPView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->drymatstructtotpop();
    }
};
