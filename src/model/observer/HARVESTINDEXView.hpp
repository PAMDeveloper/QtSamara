...
#ifndef MODEL_OBSERVER_HARVESTINDEXVIEW_HPP
#define MODEL_OBSERVER_HARVESTINDEXVIEW_HPP
...
class HARVESTINDEXView : public View
{
public:
    HARVESTINDEXView()
    { }

    virtual ~HARVESTINDEXView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->harvestindex();
    }
};
