...
#ifndef MODEL_OBSERVER_CSTRASSIMVIEW_HPP
#define MODEL_OBSERVER_CSTRASSIMVIEW_HPP
...
class CSTRASSIMView : public View
{
public:
    CSTRASSIMView()
    { }

    virtual ~CSTRASSIMView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->cstrassim();
    }
};
