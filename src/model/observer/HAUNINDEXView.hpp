...
#ifndef MODEL_OBSERVER_HAUNINDEXVIEW_HPP
#define MODEL_OBSERVER_HAUNINDEXVIEW_HPP
...
class HAUNINDEXView : public View
{
public:
    HAUNINDEXView()
    { }

    virtual ~HAUNINDEXView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->haunindex();
    }
};
