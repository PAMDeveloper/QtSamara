...
#ifndef MODEL_OBSERVER_PLANTLEAFNUMTOTVIEW_HPP
#define MODEL_OBSERVER_PLANTLEAFNUMTOTVIEW_HPP
...
class PLANTLEAFNUMTOTView : public View
{
public:
    PLANTLEAFNUMTOTView()
    { }

    virtual ~PLANTLEAFNUMTOTView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->plantleafnumtot();
    }
};
