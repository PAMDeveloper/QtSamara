...
#ifndef MODEL_OBSERVER_CONVERSIONEFFVIEW_HPP
#define MODEL_OBSERVER_CONVERSIONEFFVIEW_HPP
...
class CONVERSIONEFFView : public View
{
public:
    CONVERSIONEFFView()
    { }

    virtual ~CONVERSIONEFFView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->conversioneff();
    }
};
