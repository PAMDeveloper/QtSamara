...
#ifndef MODEL_OBSERVER_RESPMAINTTOTVIEW_HPP
#define MODEL_OBSERVER_RESPMAINTTOTVIEW_HPP
...
class RESPMAINTTOTView : public View
{
public:
    RESPMAINTTOTView()
    { }

    virtual ~RESPMAINTTOTView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->respmainttot();
    }
};
