...
#ifndef MODEL_OBSERVER_INTERNODERESSTATUSVIEW_HPP
#define MODEL_OBSERVER_INTERNODERESSTATUSVIEW_HPP
...
class INTERNODERESSTATUSView : public View
{
public:
    INTERNODERESSTATUSView()
    { }

    virtual ~INTERNODERESSTATUSView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->internoderesstatus();
    }
};
