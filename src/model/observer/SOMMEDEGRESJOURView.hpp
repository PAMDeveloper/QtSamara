...
#ifndef MODEL_OBSERVER_SOMMEDEGRESJOURVIEW_HPP
#define MODEL_OBSERVER_SOMMEDEGRESJOURVIEW_HPP
...
class SOMMEDEGRESJOURView : public View
{
public:
    SOMMEDEGRESJOURView()
    { }

    virtual ~SOMMEDEGRESJOURView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->sommedegresjour();
    }
};
