...
#ifndef MODEL_OBSERVER_GRAINYIELDPOPVIEW_HPP
#define MODEL_OBSERVER_GRAINYIELDPOPVIEW_HPP
...
class GRAINYIELDPOPView : public View
{
public:
    GRAINYIELDPOPView()
    { }

    virtual ~GRAINYIELDPOPView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->grainyieldpop();
    }
};
