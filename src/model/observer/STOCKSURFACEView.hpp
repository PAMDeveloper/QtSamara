...
#ifndef MODEL_OBSERVER_STOCKSURFACEVIEW_HPP
#define MODEL_OBSERVER_STOCKSURFACEVIEW_HPP
...
class STOCKSURFACEView : public View
{
public:
    STOCKSURFACEView()
    { }

    virtual ~STOCKSURFACEView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->stocksurface();
    }
};
