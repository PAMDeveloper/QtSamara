...
#ifndef MODEL_OBSERVER_STOCKMACROPORESVIEW_HPP
#define MODEL_OBSERVER_STOCKMACROPORESVIEW_HPP
...
class STOCKMACROPORESView : public View
{
public:
    STOCKMACROPORESView()
    { }

    virtual ~STOCKMACROPORESView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->stockmacropores();
    }
};
