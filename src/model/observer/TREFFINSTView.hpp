...
#ifndef MODEL_OBSERVER_TREFFINSTVIEW_HPP
#define MODEL_OBSERVER_TREFFINSTVIEW_HPP
...
class TREFFINSTView : public View
{
public:
    TREFFINSTView()
    { }

    virtual ~TREFFINSTView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->treffinst();
    }
};
