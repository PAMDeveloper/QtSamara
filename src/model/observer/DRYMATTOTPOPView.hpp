...
#ifndef MODEL_OBSERVER_DRYMATTOTPOPVIEW_HPP
#define MODEL_OBSERVER_DRYMATTOTPOPVIEW_HPP
...
class DRYMATTOTPOPView : public View
{
public:
    DRYMATTOTPOPView()
    { }

    virtual ~DRYMATTOTPOPView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->drymattotpop();
