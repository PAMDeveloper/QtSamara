...
#ifndef MODEL_OBSERVER_DAYLENGTHVIEW_HPP
#define MODEL_OBSERVER_DAYLENGTHVIEW_HPP
...
class DAYLENGTHView : public View
{
public:
    DAYLENGTHView()
    { }

    virtual ~DAYLENGTHView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->daylength();
    }
};
