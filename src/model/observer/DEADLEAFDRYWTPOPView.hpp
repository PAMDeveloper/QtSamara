...
#ifndef MODEL_OBSERVER_DEADLEAFDRYWTPOPVIEW_HPP
#define MODEL_OBSERVER_DEADLEAFDRYWTPOPVIEW_HPP
...
class DEADLEAFDRYWTPOPView : public View
{
public:
    DEADLEAFDRYWTPOPView()
    { }

    virtual ~DEADLEAFDRYWTPOPView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->deadleafdrywtpop();
    }
};
