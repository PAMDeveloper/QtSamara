...
#ifndef MODEL_OBSERVER_PLANTWIDTHVIEW_HPP
#define MODEL_OBSERVER_PLANTWIDTHVIEW_HPP
...
class PLANTWIDTHView : public View
{
public:
    PLANTWIDTHView()
    { }

    virtual ~PLANTWIDTHView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->plantwidth();
    }
};
