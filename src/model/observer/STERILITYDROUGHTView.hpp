...
#ifndef MODEL_OBSERVER_STERILITYDROUGHTVIEW_HPP
#define MODEL_OBSERVER_STERILITYDROUGHTVIEW_HPP
...
class STERILITYDROUGHTView : public View
{
public:
    STERILITYDROUGHTView()
    { }

    virtual ~STERILITYDROUGHTView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->sterilitydrought();
    }
};
