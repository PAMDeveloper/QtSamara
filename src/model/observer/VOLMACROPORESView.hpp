...
#ifndef MODEL_OBSERVER_VOLMACROPORESVIEW_HPP
#define MODEL_OBSERVER_VOLMACROPORESVIEW_HPP
...
class VOLMACROPORESView : public View
{
public:
    VOLMACROPORESView()
    { }

    virtual ~VOLMACROPORESView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->volmacropores();
    }
};
