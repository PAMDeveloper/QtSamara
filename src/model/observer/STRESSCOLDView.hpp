...
#ifndef MODEL_OBSERVER_STRESSCOLDVIEW_HPP
#define MODEL_OBSERVER_STRESSCOLDVIEW_HPP
...
class STRESSCOLDView : public View
{
public:
    STRESSCOLDView()
    { }

    virtual ~STRESSCOLDView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->stresscold();
    }
};
