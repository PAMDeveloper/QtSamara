...
#ifndef MODEL_OBSERVER_IRRIGAUTODAYVIEW_HPP
#define MODEL_OBSERVER_IRRIGAUTODAYVIEW_HPP
...
class IRRIGAUTODAYView : public View
{
public:
    IRRIGAUTODAYView()
    { }

    virtual ~IRRIGAUTODAYView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->irrigautoday();
    }
};
