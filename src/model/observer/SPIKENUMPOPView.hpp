...
#ifndef MODEL_OBSERVER_SPIKENUMPOPVIEW_HPP
#define MODEL_OBSERVER_SPIKENUMPOPVIEW_HPP
...
class SPIKENUMPOPView : public View
{
public:
    SPIKENUMPOPView()
    { }

    virtual ~SPIKENUMPOPView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->spikenumpop();
    }
};
