...
#ifndef MODEL_OBSERVER_ASSIMSURPLUSVIEW_HPP
#define MODEL_OBSERVER_ASSIMSURPLUSVIEW_HPP
...
class ASSIMSURPLUSView : public View
{
public:
    ASSIMSURPLUSView()
    { }

    virtual ~ASSIMSURPLUSView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->assimsurplus();
    }
};
