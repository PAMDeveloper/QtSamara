...
#ifndef MODEL_OBSERVER_RESPMAINTDEBTVIEW_HPP
#define MODEL_OBSERVER_RESPMAINTDEBTVIEW_HPP
...
class RESPMAINTDEBTView : public View
{
public:
    RESPMAINTDEBTView()
    { }

    virtual ~RESPMAINTDEBTView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->respmaintdebt();
    }
};
