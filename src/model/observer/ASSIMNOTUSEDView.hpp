...
#ifndef MODEL_OBSERVER_ASSIMNOTUSEDVIEW_HPP
#define MODEL_OBSERVER_ASSIMNOTUSEDVIEW_HPP
...
class ASSIMNOTUSEDView : public View
{
public:
    ASSIMNOTUSEDView()
    { }

    virtual ~ASSIMNOTUSEDView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->assimnotused();
    }
};
