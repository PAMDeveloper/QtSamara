...
#ifndef MODEL_OBSERVER_RELPOTLEAFLENGTHVIEW_HPP
#define MODEL_OBSERVER_RELPOTLEAFLENGTHVIEW_HPP
...
class RELPOTLEAFLENGTHView : public View
{
public:
    RELPOTLEAFLENGTHView()
    { }

    virtual ~RELPOTLEAFLENGTHView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->relpotleaflength();
    }
};
