...
#ifndef MODEL_OBSERVER_ROOTMASSPERVOLVIEW_HPP
#define MODEL_OBSERVER_ROOTMASSPERVOLVIEW_HPP
...
class ROOTMASSPERVOLView : public View
{
public:
    ROOTMASSPERVOLView()
    { }

    virtual ~ROOTMASSPERVOLView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->rootmasspervol();
    }
};
