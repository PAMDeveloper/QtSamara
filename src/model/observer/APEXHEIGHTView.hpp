...
#ifndef MODEL_OBSERVER_APEXHEIGHTVIEW_HPP
#define MODEL_OBSERVER_APEXHEIGHTVIEW_HPP
...
class APEXHEIGHTView : public View
{
public:
    APEXHEIGHTView()
    { }

    virtual ~APEXHEIGHTView()
    { }

    virtual void observe(double /* t */)
    {
        std::cout << "\t" << model->apexheight();
    }
};
