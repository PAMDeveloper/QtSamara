...
void ParametersReader::loadFromJSON(
        const std::string& json, samara::ModelParameters& parameters)
{
    using boost::property_tree::ptree;
...
//        const std::string& id, samara::ModelParameters& parameters)
//{
//#if 1
...
//    artis::utils::DateTime::format_date(parameters.get < std::string >("BeginDate"),
//                                 beginDate);
//    artis::utils::DateTime::format_date(parameters.get < std::string >("EndDate"),
//                                 endDate);
//    begin = artis::utils::DateTime::toJulianDayNumber(beginDate);
//    end = artis::utils::DateTime::toJulianDayNumber(endDate);
//    beginYear = artis::utils::DateTime::year(begin);
//    endYear = artis::utils::DateTime::year(end);
...
//                //artis::utils::DateTime::format_date(boost::lexical_cast < std::string >(PQgetvalue(result, i, 0)), day);
//                //                artis::utils::DateTime::format_date(
//                //                            boost::lexical_cast <std::string >(
//                //                                itMeteorology->at(1)), day);
//                //                t = artis::utils::DateTime::toJulianDayNumber(day);

//                t = artis::utils::DateTime::toJulianDayNumber(
